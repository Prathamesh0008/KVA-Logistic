                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <div className="flex-grow relative">
                        ...
                        />
                        <Package className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5" 
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {statusOptions.map((status) => (
                        <button
                          ...
                          style={{
                            backgroundColor: activeStatus === status.id ? status.bgColor + '20' : `${colors.lightTan}10`,
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button 
                        ...
                        style={{
                          ...
                          color: autoRefresh ? colors.darkBrown : colors.darkBrown,
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <div className="text-2xl font-bold">{estimatedDelivery}</div>
                  <div 
                    className="text-sm mt-2"
                    style={{ color: colors.darkBrown, opacity: 0.7 }}
                  >
                  ...
                  <div 
                    ...
                    style={{ backgroundColor: `${colors.lightTan}50` }}
                  >
                    <div 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <p 
                  ...
                  style={{ color: colors.darkBrown, opacity: 0.7 }}
                >
                  Call <span className="font-bold">+316872022074</span> or email support@logisticskva.com
                </p>
              </div>
            </div>
          </div>
