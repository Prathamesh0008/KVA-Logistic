        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-10 lg:mb-14 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2" style={highlightText}>
                150+
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4 sm:mb-6">
                    ...
                    {/* ✅ Highlight service stats */}
                    <div className="text-right">
                      <div className="text-sm sm:text-base font-bold" style={highlightText}>
                        {service.stats}
                      </div>
                    </div>
                  </div>
                  ...
                  <h3 className="text-xl font-bold mb-2 sm:mb-3" style={highlightText}>
                    {service.title}
                  </h3>
                  ...
                  <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8 flex-grow">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start group/item">
                        ...
                        <span className="text-xs sm:text-sm" style={{ color: colors.darkBrown, opacity: 0.9 }}>
                          {feature}
                        </span>
                      </li>
                    ))}
          ...
          <div className="mt-12 sm:mt-16 lg:mt-20 text-center">
            ...
            >
              <div className="inline-flex items-center justify-center gap-2 mb-4 sm:mb-6">
                <Shield className="h-10 w-10 sm:h-12 sm:w-12" style={{ color: colors.goldenYellow }} />
                <Clock className="h-8 w-8 sm:h-10 sm:w-10" style={{ color: colors.orange }} />
                <MapPin className="h-10 w-10 sm:h-12 sm:w-12" style={{ color: colors.darkBrown }} />
              </div>

              {/* ✅ Highlight CTA title */}
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4" style={highlightText}>
                Need Custom Logistics Solutions?
              </h3>

              <p className="mb-6 sm:mb-8 max-w-2xl mx-auto text-sm sm:text-base" style={{ color: colors.darkBrown, opacity: 0.8 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                ...
                >
                  {/* ✅ Highlight secondary CTA text */}
                  <span style={highlightText}>View All Services</span>
          ...
          <div className="mt-12 sm:mt-16">
            <div className="text-center mb-6 sm:mb-8">
              {/* ✅ Highlight trust heading */}
              <h4 className="text-sm sm:text-base font-semibold mb-2 tracking-wider" style={highlightText}>
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 lg:gap-10" style={{ color: colors.darkBrown, opacity: 0.8 }}>
              {/* ✅ Highlight brand names */}
              <div className="text-base sm:text-lg font-bold tracking-wide opacity-70 hover:opacity-100 transition-opacity" style={highlightText}>
                MAERSK
              </div>
              <div className="text-base sm:text-lg font-bold tracking-wide opacity-70 hover:opacity-100 transition-opacity" style={highlightText}>
                DHL
      ...
      {selectedService && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div
              className="sticky top-0 z-10 p-6 border-b rounded-t-2xl flex justify-between items-center"
              style={{
                backgroundColor: 'white',
            ...
            <div className="p-6 sm:p-8">
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t" style={{ borderColor: colors.lightTan + '30' }}>
                <Link
                  href="/contact"
