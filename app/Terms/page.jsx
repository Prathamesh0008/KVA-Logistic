...
export default function TeamsPage() {
  return (
    <main className="bg-white min-h-screen flex flex-col">
      <section className="mx-auto max-w-6xl px-4 w-full min-h-[calc(100vh-80px)] flex flex-col">
        {/* Top content wrapper – adds top spacing only */}
        ...
        {/* Bottom callout – now flows naturally after the grid */}
        <div className="mt-10 rounded-2xl border-2 border-[#C55500] bg-gradient-to-r from-[#310F0B] to-[#9F4100] p-6 text-white shadow-xl">
        ...
        {/* Small bottom padding for consistent spacing on all devices */}
        <div className="pb-1" />
      </section>
    </main>
  );
