  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-1 sm:px-4">
        <div className="flex items-center justify-between h-17 sm:h-16 lg:h-18 pt-1 pb-1">
          {/* LOGO - bigger on desktop only */}
          <Link href="/" className="flex shrink-0">
            <img
              src="/logo.png"
              alt="KVA Logistics"
              className="h-22 sm:h-21 lg:h-27 object-cover"   // 👈 changed lg:h-25 → lg:h-32
            />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-xl px-5 py-3 text-sm text-gray-700 border border-gray-300 hover:bg-gray-50 transition-all duration-300"
              style={{
                fontFamily: "var(--font-snasm)",
                fontWeight: 400,
                letterSpacing: "0.02em"
          ...
          <div className="flex lg:hidden items-center gap-2">
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-medium border border-blue-300 text-gray-700 bg-white transition-all duration-300"
              style={{
                fontFamily: "var(--font-snasm)",
                letterSpacing: "0.02em"
              }}
