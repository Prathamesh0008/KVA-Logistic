      ...
      <div className="max-w-7xl mx-auto px-1 sm:px-4">
        <div className="flex items-center justify-between h-17 sm:h-16 lg:h-18 pt-1 pb-1">
          ...
          <div className="flex lg:hidden items-center gap-2">
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-medium border border-red-300 text-gray-700 bg-white transition-all duration-300"
              style={{
                fontFamily: "var(--font-snasm)",
                letterSpacing: "0.02em"
              }}
