      ...
      <div className="max-w-7xl mx-auto px-1 sm:px-4">
        <div className="flex items-center justify-between h-17 sm:h-16 lg:h-18 pt-1 pb-1">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-xl px-5 py-3 text-sm text-gray-700 border-xl border-red-300 hover:bg-gray-50 transition-all duration-300"
              style={{
                fontFamily: "var(--font-snasm)",
                fontWeight: 400,
                letterSpacing: "0.02em"
